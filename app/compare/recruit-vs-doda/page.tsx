      ...
      <article className="max-w-4xl mx-auto px-4 py-10">
        ...
        <section id="kyujin" className="mb-12 scroll-mt-20">
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-lg p-5 text-sm text-slate-700">
            <p><strong>まとめ：</strong>非公開求人を含む総量の多さならリクルート、自分でも探せる柔軟さならdoda。なお、いずれも総合型のためIT専門性は<Link href="/compare/levtech-vs-doda/" className="text-blue-600 hover:underline">IT特化型エージェント</Link>に一歩譲る場面があり、併用が前提になります。</p>
          </div>
        </section>
        ...
        <section id="salary" className="mb-12 scroll-mt-20">
          ...
          <p className="text-slate-600 leading-relaxed text-sm">年代別の年収相場は<Link href="/compare/salary-ranking/" className="text-blue-600 hover:underline">年収ランキング</Link>、交渉の具体策は<Link href="/knowledge/salary-negotiation/" className="text-blue-600 hover:underline">年収交渉のコツ</Link>もあわせてご確認ください。</p>
        </section>
        ...
        <section id="support" className="mb-12 scroll-mt-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
            <div className="bg-blue-50 rounded-lg p-5">
              ...
              <p className="text-sm text-blue-700 leading-relaxed">蓄積された実績に基づく書類添削・面接対策が丁寧という評判があります（Qiita Job Change等）。一方で、対応が事務的という声や、サポート期間が3か月で短いという指摘もあり、期間内に集中して動ける人に向きます。</p>
            </div>
          ...
          <p className="text-slate-600 leading-relaxed text-sm">どちらもアドバイザー個人の力量に左右されるため、相性が合わない場合は担当変更を申し出るのが有効です。<Link href="/knowledge/agent-first-meeting/" className="text-blue-600 hover:underline">初回面談の進め方</Link>も参考にしてください。</p>
        </section>
        ...
        <section id="checklist" className="mb-12 scroll-mt-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="bg-blue-50 rounded-lg p-5">
              ...
              <ul className="space-y-2 text-sm text-blue-700">{goodRec.map((t, i) => (<li key={i}>✓ {t}</li>))}</ul>
            </div>
