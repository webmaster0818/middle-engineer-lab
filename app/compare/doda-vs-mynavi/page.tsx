      ...
      <article className="max-w-4xl mx-auto px-4 py-10">
        ...
        <section id="kyujin" className="mb-12 scroll-mt-20">
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-lg p-5 text-sm text-slate-700">
            <p><strong>まとめ：</strong>選択肢の広さならdoda、特化した提案の精度ならマイナビIT AGENT。ハイクラスや地方求人も視野に入れるなら、求人量の多いdodaを軸に据えるのが安全です。<Link href="/compare/agents/" className="text-blue-600 hover:underline">10社比較</Link>もあわせてご確認ください。</p>
          </div>
        </section>
        ...
        <section id="salary" className="mb-12 scroll-mt-20">
          ...
          <p className="text-slate-600 leading-relaxed text-sm">年代別の年収相場は<Link href="/compare/salary-ranking/" className="text-blue-600 hover:underline">年収ランキング</Link>、交渉の具体策は<Link href="/knowledge/salary-negotiation/" className="text-blue-600 hover:underline">年収交渉のコツ</Link>もあわせてご覧ください。</p>
        </section>
        ...
        <section id="support" className="mb-12 scroll-mt-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
            <div className="bg-blue-50 rounded-lg p-5">
              ...
              <p className="text-sm text-blue-700 leading-relaxed">2名体制でサポートされる場合があり、求人紹介とサポートが分業されることがあります。自己分析ツールやコンテンツが充実しており、自分で考えながら進めたい人に向きます。一方でIT専門性がやや低い、アドバイザーの質にばらつきがあるという声も見られます（freeconsul／HonNe等）。</p>
            </div>
          ...
          <p className="text-slate-600 leading-relaxed text-sm">手厚い伴走を求めるならマイナビ、自分で進めつつコンテンツも活用したいならdoda。<Link href="/knowledge/agent-first-meeting/" className="text-blue-600 hover:underline">初回面談の進め方</Link>も参考にしてください。</p>
        </section>
        ...
        <section id="checklist" className="mb-12 scroll-mt-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="bg-blue-50 rounded-lg p-5">
              ...
              <ul className="space-y-2 text-sm text-blue-700">{goodDoda.map((t, i) => (<li key={i}>✓ {t}</li>))}</ul>
            </div>
        ...
        <section id="middle" className="mb-12 scroll-mt-20">
          ...
          <p className="text-slate-600 leading-relaxed mb-4"><strong>40代エンジニアの場合：</strong>マイナビIT AGENTは20〜30代の若手層に強く、ハイクラス・地方求人が手薄という指摘があるため（axxis等）、40代は注意が必要です。40代はdodaを主軸に据え、求人の母数とハイクラス・地方求人の選択肢を確保するのが現実的です。マイナビは書類・面接のサポート補強として併用すると、強みだけを取り込めます。<Link href="/age/40s/" className="text-blue-600 hover:underline">40代の転職事情</Link>もあわせてご覧ください。</p>
