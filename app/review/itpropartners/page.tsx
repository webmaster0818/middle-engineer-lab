      ...
      <article className="max-w-4xl mx-auto px-4 py-10">
        ...
        <section id="sources" className="mb-10 scroll-mt-20">
          ...
          <p className="text-sm text-slate-600 mb-4 leading-relaxed">
            本記事の「良い評判・悪い評判の傾向」は、以下の口コミ・評判メディアに掲載された声を参照して傾向を要約したものです（原文・スコアの転載ではありません）。最新の内容は各リンク先でご確認ください。
          </p>
          <ul className="space-y-2 text-sm text-slate-600 border border-slate-200 rounded-lg p-5 bg-slate-50">
            <li className="flex items-start gap-2">
              ...
              <a href="https://exidea.co.jp/blog/job/freelance/itpro-partners/" rel="nofollow noopener" target="_blank" className="text-petrol hover:underline font-medium">
                HonNe（ホンネ）：ITプロパートナーズの評判・口コミと案件の特徴
              </a>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-petrol shrink-0">›</span>
              <a href="https://jobs.qiita.com/itpropartners/" rel="nofollow noopener" target="_blank" className="text-petrol hover:underline font-medium">
                Qiita Job Change：ITプロパートナーズの評判・口コミ
              </a>
            </li>
          </ul>
          <p className="text-xs text-slate-400 mt-3">
            ※各リンク先の実在は2026年7月時点で確認しています。外部サイトの内容・URLは予告なく変更される場合があります。案件数・登録者数などの数値は最新を公式サイトでご確認ください。
          </p>
        </section>
        ...
        <section className="bg-gradient-to-r from-blue-600 to-blue-800 text-white rounded-xl p-8 mb-10 text-center">
          ...
          <a href="https://itpropartners.com/" target="_blank" rel="nofollow noopener" className="inline-block bg-white text-petrol-deep font-bold py-3 px-8 rounded-lg hover:bg-petrol-soft transition-colors">
            無料相談を予約する
          </a>
        </section>
