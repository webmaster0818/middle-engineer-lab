...
export const metadata: Metadata = {
  alternates: { canonical: "/review/techreach/" },
  title: TITLE,
...
const faqs = [
  ...
  },
  {
    ...
    a: "業務委託案件は即戦力前提で、高単価・エンド直ゆえに求められるスキル水準も高めです。実務経験が浅い場合は、まず正社員で経験を積んでから独立する方が現実的です。安定雇用での経験積みは正社員転職のレバテックキャリア（/review/levtech/）が向いています。",
  },
  {
    q: "登録は無料ですか？",
    ...
    <>
      ...
      <article className="max-w-4xl mx-auto px-4 py-10">
        ...
        <section className="bg-gradient-to-r from-blue-600 to-blue-800 text-white rounded-xl p-8 mb-10 text-center">
          ...
          <a href="https://tech-reach.jp/" target="_blank" rel="nofollow noopener" className="inline-block bg-white text-petrol-deep font-bold py-3 px-8 rounded-lg hover:bg-petrol-soft transition-colors">
            無料カウンセリングを予約する
          </a>
        </section>
