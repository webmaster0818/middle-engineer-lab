      ...
      <article className="max-w-4xl mx-auto px-4 py-10">
        ...
        <section id="learn" className="mb-10">
          ...
          <div className="space-y-3 text-sm text-slate-600 leading-relaxed">
            <p>
              <strong>① RDBの基礎を製品横断で固める。</strong>正規化、インデックス、トランザクション、実行計画といった基礎は<Link href="/skill/sql/" className="text-blue-600 hover:underline">SQL／データベース</Link>の共通言語です。ここを固めると、PostgreSQL固有の機能の理解も速くなります。
            </p>
            <p>
