      ...
      <article className="max-w-4xl mx-auto px-4 py-10">
        ...
        <section className="mb-6">
          ...
          <p className="text-slate-600 leading-relaxed">
            本記事では、フレームワークとしてのDjangoを軸に、転職の「攻め方」を<strong>公表年収データ・求められる経験レベル・求人の探し方・他フレームワークからの参入ルート</strong>に分けて、30代・40代の視点を交えて整理します。Python全体の市場は<Link href="/skill/python/" className="text-blue-600 hover:underline">Pythonエンジニアの転職ガイド</Link>もあわせてご覧ください。
          </p>
        </section>
