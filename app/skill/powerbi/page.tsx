      ...
      <article className="max-w-4xl mx-auto px-4 py-10">
        ...
        <section id="career" className="mb-10">
          ...
          <p className="text-xs text-slate-500 mt-3">
            関連スキルは<Link href="/skill/sql/" className="text-blue-600 hover:underline">SQL</Link>・<Link href="/skill/data-analyst/" className="text-blue-600 hover:underline">データアナリスト</Link>・<Link href="/skill/tableau/" className="text-blue-600 hover:underline">Tableau</Link>のガイドもあわせてご覧ください。
          </p>
        </section>
