      ...
      <article className="max-w-4xl mx-auto px-4 py-10">
        ...
        <section id="find" className="mb-10">
          ...
          <p className="text-xs text-slate-500 mt-3">
            求人母数を最大化したい場合は<Link href="/review/recruit-it/" className="text-petrol hover:underline">リクルートエージェントIT</Link>や<Link href="/review/doda-it/" className="text-petrol hover:underline">doda ITエンジニア</Link>も併用候補です。複数併用の進め方は<Link href="/knowledge/multiple-agents/" className="text-petrol hover:underline">エージェント複数利用ガイド</Link>を参照してください。
          </p>
        </section>
        ...
        <section id="entry" className="mb-10">
          ...
          <p className="text-xs text-slate-500 mt-3">
            関連: <Link href="/knowledge/portfolio/" className="text-petrol hover:underline">ポートフォリオの作り方</Link> / <Link href="/knowledge/inexperienced-30s/" className="text-petrol hover:underline">30代・実務浅めからの転職</Link>
          </p>
        </section>
        ...
        <section id="middle" className="mb-10">
          ...
          <p className="text-sm text-slate-600 leading-relaxed">
            一方、年齢が上がるほど「マネジメントもできるのか」を問われやすくなります。テックリード・EMの両にらみで職務経歴書を整理し、技術とチーム貢献の両面を書き分けると刺さりやすくなります。年代別の市場感は<Link href="/age/30s/" className="text-petrol hover:underline">30代の転職ガイド</Link>・<Link href="/age/40s/" className="text-petrol hover:underline">40代の転職ガイド</Link>も参照してください。
          </p>
        </section>
