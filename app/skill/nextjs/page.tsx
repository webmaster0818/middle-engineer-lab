    ...
    <>
      ...
      <section className="mx-auto max-w-3xl px-4 pb-10">
        <div className="rounded-xl bg-slate-50 border border-slate-200 p-5">
          ...
          <ul className="grid grid-cols-2 sm:grid-cols-3 gap-1 text-sm"><li><a href="/company/gmo-internet/" className="text-petrol-deep hover:underline">GMOインターネットグループ</a></li><li><a href="/company/mercari/" className="text-petrol-deep hover:underline">メルカリ</a></li><li><a href="/company/mixi/" className="text-petrol-deep hover:underline">MIXI（ミクシィ）</a></li><li><a href="/company/note/" className="text-petrol-deep hover:underline">note（ノート）</a></li><li><a href="/company/timee/" className="text-petrol-deep hover:underline">タイミー（Timee）</a></li><li><a href="/company/uzabase/" className="text-petrol-deep hover:underline">ユーザベース（UZABASE）</a></li></ul>
