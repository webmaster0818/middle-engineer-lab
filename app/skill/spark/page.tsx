      ...
      <article className="max-w-4xl mx-auto px-4 py-10">
        ...
        <section id="career" className="mb-10">
          ...
          <p className="text-xs text-slate-500 mt-3">
            関連スキルは<Link href="/skill/python/" className="text-blue-600 hover:underline">Python</Link>・<Link href="/skill/sql/" className="text-blue-600 hover:underline">SQL</Link>・<Link href="/skill/data-scientist/" className="text-blue-600 hover:underline">データサイエンティスト</Link>のガイドもあわせてご覧ください。
          </p>
        </section>
