      ...
      <article className="max-w-4xl mx-auto px-4 py-10">
        ...
        <section id="why-hard" className="mb-10 scroll-mt-20">
          ...
          <p className="text-slate-600 leading-relaxed mt-5 text-sm">
            40代のリアルをさらに掘り下げた<Link href="/knowledge/40s-reality/" className="text-blue-600 hover:underline">40代エンジニア転職の現実</Link>や、<Link href="/knowledge/age-discrimination/" className="text-blue-600 hover:underline">年齢と転職</Link>もあわせてご覧ください。
          </p>
        </section>
        ...
        <section id="patterns" className="mb-10 scroll-mt-20">
          ...
          <p className="text-slate-600 leading-relaxed mt-5 text-sm">
            実績の数値化は<Link href="/knowledge/resume/" className="text-blue-600 hover:underline">職務経歴書の書き方</Link>、市場価値の確認は<Link href="/knowledge/market-value/" className="text-blue-600 hover:underline">自分の市場価値を知る方法</Link>を参考にしてください。
          </p>
        </section>
        ...
        <section id="strategy" className="mb-10 scroll-mt-20">
          ...
          <p className="text-slate-600 leading-relaxed mt-5 text-sm">
            キャリア設計の考え方は<Link href="/knowledge/career-plan/" className="text-blue-600 hover:underline">エンジニアのキャリアプラン</Link>、年収の動きは<Link href="/knowledge/salary-40s/" className="text-blue-600 hover:underline">40代の年収のリアル</Link>も参考になります。
          </p>
        </section>
          ...
          <div className="space-y-4">
            {agents.map((agent, i) => (
              <div key={i} className="border border-slate-200 rounded-lg p-5">
                ...
                <p className="text-xs text-blue-600 font-medium">こんな40代向き: {agent.fit}</p>
              </div>
            ))}
          </div>
          <p className="text-slate-600 leading-relaxed mt-5 text-sm">
            40代向けの比較は<Link href="/compare/40s-agents/" className="text-blue-600 hover:underline">40代エンジニアにおすすめのエージェント比較</Link>、ハイクラス志向なら<Link href="/compare/highclass/" className="text-blue-600 hover:underline">ハイクラス向けエージェント比較</Link>も参考になります。
          </p>
        </section>
