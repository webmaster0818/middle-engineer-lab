      ...
      <article className="max-w-4xl mx-auto px-4 py-10">
        ...
        <section id="conclusion" className="mb-10 scroll-mt-20">
          <div className="bg-petrol-soft border border-[var(--line)] rounded-xl p-6">
            ...
            <ul className="space-y-2 text-sm text-slate-700">
              <li className="flex gap-2"><span className="text-petrol font-bold shrink-0">1.</span>厚労省 job tagではSEの平均年齢は37.1歳。35歳は職種の中心層で、年齢的に外れていない。</li>
              <li className="flex gap-2"><span className="text-petrol font-bold shrink-0">2.</span>経産省試算では2030年に最大約79万人のIT人材不足（2019年公表）で、経験者需要が続く。</li>
        ...
        <section id="change" className="mb-10 scroll-mt-20">
          ...
          <p className="text-slate-600 leading-relaxed mt-5 text-sm">
            年代の前後比較は<Link href="/age/30s/" className="text-petrol hover:underline">30代エンジニアの転職ガイド</Link>と<Link href="/age/40s/" className="text-petrol hover:underline">40代エンジニアの転職は厳しい？</Link>もあわせてご覧ください。
          </p>
        </section>
        ...
        <section id="patterns" className="mb-10 scroll-mt-20">
          ...
          <p className="text-slate-600 leading-relaxed mt-5 text-sm">
            実績の語り方は<Link href="/knowledge/resume/" className="text-petrol hover:underline">職務経歴書の書き方</Link>、年齢の不安については<Link href="/knowledge/age-discrimination/" className="text-petrol hover:underline">年齢と転職</Link>でも掘り下げています。
          </p>
        </section>
        ...
        <section id="strategy" className="mb-10 scroll-mt-20">
          ...
          <p className="text-slate-600 leading-relaxed mt-5 text-sm">
            キャリア設計の考え方は<Link href="/knowledge/career-plan/" className="text-petrol hover:underline">エンジニアのキャリアプラン</Link>、市場価値の測り方は<Link href="/knowledge/market-value/" className="text-petrol hover:underline">自分の市場価値を知る方法</Link>を参考にしてください。
          </p>
        </section>
          ...
          <div className="space-y-4">
            {agents.map((agent, i) => (
              <div key={i} className="border border-slate-200 rounded-lg p-5">
                ...
                <p className="text-xs text-petrol font-medium">こんな35歳向き: {agent.fit}</p>
              </div>
            ))}
          </div>
          <p className="text-slate-600 leading-relaxed mt-5 text-sm">
