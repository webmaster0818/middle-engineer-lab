      ...
      <article className="max-w-4xl mx-auto px-4 py-10">
        ...
        <section id="jobs" className="mb-10 scroll-mt-20">
          ...
          <p className="text-sm text-slate-600 leading-relaxed mt-4">
            インフラ・ネットワーク方向は<Link href="/skill/network/" className="text-petrol hover:underline">ネットワークエンジニア転職ガイド</Link>・<Link href="/skill/infrastructure/" className="text-petrol hover:underline">インフラエンジニア転職ガイド</Link>、セキュリティ方向は<Link href="/skill/security/" className="text-petrol hover:underline">セキュリティエンジニア転職ガイド</Link>を参考にしてください。
          </p>
        </section>
        ...
        <section id="steps" className="mb-10 scroll-mt-20">
          ...
          <p className="text-sm text-slate-600 leading-relaxed">
            前段の基礎が不安なら<Link href="/cert/applied-info/" className="text-petrol hover:underline">応用情報技術者</Link>や<Link href="/cert/ccna/" className="text-petrol hover:underline">CCNA</Link>から、専門を広げるならセキュリティの<Link href="/cert/security-specialist/" className="text-petrol hover:underline">情報処理安全確保支援士</Link>、クラウドの<Link href="/skill/aws/" className="text-petrol hover:underline">AWS認定</Link>との組み合わせも有効です。
          </p>
        </section>
