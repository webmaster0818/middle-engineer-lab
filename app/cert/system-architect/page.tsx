      ...
      <article className="max-w-4xl mx-auto px-4 py-10">
        ...
        <section id="jobs" className="mb-10 scroll-mt-20">
          ...
          <p className="text-sm text-slate-600 leading-relaxed mt-4">
            設計・上流方向は<Link href="/knowledge/system-design/" className="text-petrol hover:underline">システム設計の考え方</Link>、マネジメント方向は<Link href="/skill/pm/" className="text-petrol hover:underline">PM（プロジェクトマネージャー）転職ガイド</Link>を参考にしてください。
          </p>
        </section>
        ...
        <section id="steps" className="mb-10 scroll-mt-20">
          ...
          <p className="text-sm text-slate-600 leading-relaxed">
            前段の基礎が不安なら<Link href="/cert/applied-info/" className="text-petrol hover:underline">応用情報技術者</Link>から、マネジメントを深めるなら<Link href="/cert/project-manager/" className="text-petrol hover:underline">プロジェクトマネージャ試験</Link>、設計と組み合わせるなら<Link href="/cert/database-specialist/" className="text-petrol hover:underline">データベーススペシャリスト</Link>との取得も有効です。
          </p>
        </section>
