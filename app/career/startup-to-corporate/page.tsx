    ...
    <>
      ...
      <article className="max-w-4xl mx-auto px-4 py-10">
        ...
        <p className="text-slate-600 leading-relaxed mb-2">
          安定した報酬体系や大規模プロジェクトへの参画を求めて、スタートアップから大企業へ転職するケースがあります。本記事は「どう転職活動を進めるか」に特化し、スキルギャップの可視化・在職中の準備ステップ・職務経歴書の書き換え例を解説します。どちらを選ぶべきかの比較は<Link href="/knowledge/startup-vs-enterprise/" className="text-blue-600 hover:underline">スタートアップと大企業どちらを選ぶ</Link>を参照してください。
        </p>
        ...
        <section id="resume" className="mb-10 scroll-mt-20">
          ...
          <p className="text-slate-500 text-xs mt-3">
            ※数値・成果はご自身の実績に置き換えてください。型は<Link href="/knowledge/resume/" className="text-blue-600 hover:underline">職務経歴書の書き方ガイド</Link>と<Link href="/knowledge/behavioral/" className="text-blue-600 hover:underline">行動面接（STAR法）対策</Link>を参照。
          </p>
        </section>
