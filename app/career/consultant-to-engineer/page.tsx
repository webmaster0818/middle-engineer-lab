      ...
      <article className="max-w-4xl mx-auto px-4 py-10">
        ...
        <section id="resume" className="mb-10 scroll-mt-20">
          ...
          <p className="text-slate-500 text-xs mt-3">
            ※数値・技術は実績に置き換えてください。型は<Link href="/knowledge/resume/" className="text-blue-600 hover:underline">職務経歴書の書き方ガイド</Link>と<Link href="/knowledge/portfolio/" className="text-blue-600 hover:underline">ポートフォリオの作り方</Link>を参照。
          </p>
        </section>
