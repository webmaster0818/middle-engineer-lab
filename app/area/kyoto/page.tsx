          ...
          <div className="space-y-4">
            ...
            <div className="border border-slate-200 rounded-lg p-5">
              ...
              <p className="text-sm text-slate-600">
                ...
                <Link href="/company/nintendo/" className="text-petrol hover:underline">任天堂の転職・採用ページ</Link>
                をご覧ください。
              </p>
            </div>
            <div className="border border-slate-200 rounded-lg p-5">
        ...
        <section id="howto" className="mb-10">
          ...
          <div className="space-y-3">
            ...
            <div className="border border-slate-200 rounded-lg p-5">
              ...
              <p className="text-sm text-slate-600">京都・大阪の求人提案量を比較します。<Link href="/knowledge/agent-first-meeting/" className="text-petrol hover:underline">初回面談の準備</Link>を済ませておくとスムーズです。</p>
            </div>
            <div className="border border-slate-200 rounded-lg p-5">
              <h3 className="font-bold text-slate-800 mb-1 text-sm">3. 専門領域を職務経歴書で言語化</h3>
              <p className="text-sm text-slate-600">ゲーム・組込み・AIなど専門性を活かすなら実績を具体的に。<Link href="/knowledge/resume/" className="text-petrol hover:underline">職務経歴書の書き方</Link>を参考に。</p>
            </div>
            <div className="border border-slate-200 rounded-lg p-5">
