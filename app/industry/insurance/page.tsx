...
export const metadata: Metadata = {
  title: "保険業界からInsurTech転職【エンジニアガイド】",
  description:
...
export default function InsurancePage() {
  ...
  return (
    <>
      <ArticleJsonLd title="保険業界からInsurTech転職【エンジニアガイド】" description="保険業界エンジニアからInsurTech領域への転職方法を徹底解説。保険の知識が活きるIT職種、年収アップの戦略、おすすめ転職エージェントを紹介します。" url="/industry/insurance/" />
