      ...
      <article className="max-w-4xl mx-auto px-4 py-10">
        ...
        <section id="company-types" className="mb-10">
          ...
          <p className="text-slate-600 leading-relaxed mb-4 text-sm">
            ...
            <Link href="/skill/ai-ml/" className="text-blue-600 hover:underline">AI・機械学習スキルのガイド</Link>
            や
            <Link href="/skill/generative-ai/" className="text-blue-600 hover:underline">生成AIスキルのガイド</Link>
            もご覧ください。
          </p>
          <div className="space-y-4">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-blue-50 rounded-lg p-5">
              ...
              <p className="text-sm text-blue-700">
                ...
                <Link href="/knowledge/generative-ai-era/" className="text-blue-700 underline">生成AI時代のエンジニアキャリア</Link>
                も参考にしてください。
              </p>
            </div>
          </div>
