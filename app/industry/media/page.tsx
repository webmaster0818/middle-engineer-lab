      ...
      <article className="max-w-4xl mx-auto px-4 py-10">
        ...
        <section id="mid-career" className="mb-10 scroll-mt-20">
          ...
          <div className="space-y-4 text-sm text-slate-600 leading-relaxed">
            ...
            <p>40代では、プレイヤーとしての開発力に加えて、チームやプロダクトをまとめる経験が評価されやすくなります。メディア時代のプロジェクト推進・部門連携の経験を、デジタルプロダクト開発の文脈で語れるよう整理しておくと選択肢が広がります。年収の考え方は<Link href="/knowledge/salary-40s/" className="text-blue-600 hover:underline">40代エンジニアの転職年収</Link>も参考にしてください。</p>
