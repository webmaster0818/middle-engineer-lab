      ...
      <article className="max-w-4xl mx-auto px-4 py-10">
        ...
        <section id="mid-career" className="mb-10 scroll-mt-20">
          ...
          <div className="space-y-4 text-sm text-slate-600 leading-relaxed">
            ...
            <p>40代では、開発力に加えてプロジェクトや関係者をまとめる経験が評価されやすくなります。農業事業で培った現場調整や改善の経験を、プロダクト開発の文脈で語れるよう整理しておくと選択肢が広がります。スタートアップ中心の領域のため、年収だけでなく事業の継続性も含めて検討するとよいでしょう。年収の考え方は<Link href="/knowledge/salary-40s/" className="text-blue-600 hover:underline">40代エンジニアの転職年収</Link>も参考にしてください。</p>
