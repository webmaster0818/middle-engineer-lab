    ...
    <>
      ...
      <article className="max-w-4xl mx-auto px-4 py-10">
        ...
        <section id="features" className="mb-10">
          ...
          <div className="space-y-4">
            <div className="bg-blue-50 rounded-lg p-5">
              ...
              <p className="text-sm text-blue-700">公式採用情報によると、大規模コンシューマーゲーム開発からソーシャルゲーム開発まで多様なプロジェクトがあり、在籍するエンジニア一人ひとりのレベルが高いとされています。配属プロジェクトにより使う技術・規模感は大きく異なります。</p>
            </div>
            <div className="bg-blue-50 rounded-lg p-5">
              <h3 className="font-bold text-blue-800 mb-2">論理的思考力を重視・未経験応募も歓迎</h3>
              <p className="text-sm text-blue-700">ゲーム開発経験がなくても、論理的思考力に基づき本質を見抜く力があれば、一部の専門性が高いセクションを除き応募可能とされています。C++未経験の応募も多いのが特徴です。</p>
            </div>
            <div className="bg-blue-50 rounded-lg p-5">
              <h3 className="font-bold text-blue-800 mb-2">独自のエンジニア研修</h3>
              <p className="text-sm text-blue-700">公式の働くストーリーによると、2024年度からプログラマー新入社員を対象に、プログラミングの基礎とゲーム制作全般の知識を身につける約3か月のエンジニア研修が実施されています。</p>
            </div>
          </div>
        </section>
        ...
        <section id="stack" className="mb-10">
          ...
          <div className="border border-slate-200 rounded-lg p-5">
            <ul className="space-y-2 text-sm text-slate-600">
              <li className="flex items-start gap-2"><span className="text-blue-600 shrink-0">●</span><span><strong>主要言語</strong>：C++、C#、Java</span></li>
              <li className="flex items-start gap-2"><span className="text-blue-600 shrink-0">●</span><span><strong>スクリプト言語</strong>：PHP、Python、Ruby、Perl、JavaScript、Lua、Squirrel など</span></li>
              <li className="flex items-start gap-2"><span className="text-blue-600 shrink-0">●</span><span><strong>その他</strong>：SQL、VBA、各種シェーダー言語、C言語、アセンブリ言語、自社オリジナル言語</span></li>
              <li className="flex items-start gap-2"><span className="text-blue-600 shrink-0">●</span><span><strong>職種例</strong>：エンジニア（プログラマー）、ITインフラエンジニア など</span></li>
            </ul>
          </div>
        ...
        <section id="flow" className="mb-10">
          ...
          <p className="text-sm text-slate-600 leading-relaxed mb-4">
            一般的な中途採用の流れをまとめます。最新かつ職種別の詳細は<a href="https://www.jp.square-enix.com/recruit/career/" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">公式中途採用ページ</a>でご確認ください。
          </p>
        ...
        <section id="interview" className="mb-10">
          ...
          <ul className="space-y-2 text-sm text-slate-600 border border-slate-200 rounded-lg p-5">
            <li className="flex items-start gap-2"><span className="text-blue-600 shrink-0">●</span>論理的思考力・本質を見抜く力</li>
            <li className="flex items-start gap-2"><span className="text-blue-600 shrink-0">●</span>C/C++等での実装力と、応募領域（レンダリング・ツール・サーバー等）の専門性</li>
            <li className="flex items-start gap-2"><span className="text-blue-600 shrink-0">●</span>これまでの開発実績・ポートフォリオ</li>
            <li className="flex items-start gap-2"><span className="text-blue-600 shrink-0">●</span>大規模開発でのチーム協働姿勢</li>
          </ul>
