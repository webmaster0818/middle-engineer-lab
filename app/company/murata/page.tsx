...
export const metadata: Metadata = {
  ...
  title: "村田製作所の年収は平均838万円【2026年・有報】エンジニア転職・選考ガイド",
  description:
    "村田製作所へのエンジニア転職を実データで解説。有価証券報告書の平均年収838万円（2026年3月期・全従業員平均）、電子部品（MLCC）・通信モジュール・組込・データ解析の技術領域、選考の考え方、30代40代の現実までまとめました。",
};
...
const basicData: [string, string][] = [
  ...
  ["平均年間給与", "838万円（2026年3月期 有価証券報告書・提出会社単体／全従業員平均）"],
  ["平均年齢", "40.5歳（2026年3月期 有価証券報告書・提出会社単体）"],
  ["従業員数", "11,174名（2026年3月期 有価証券報告書・提出会社単体）"],
  ["本社所在地", "京都府長岡京市"],
...
const faqs = [
  {
    q: "村田製作所の平均年収はいくらですか？",
    a: "2026年3月期の有価証券報告書によると、提出会社（株式会社村田製作所単体）の平均年間給与は838万円、平均年齢は40.5歳です。これは賞与等を含む全従業員平均値であり、技術職（エンジニア）に限定した値ではありません。エンジニア個人の年収は職種・等級・実績により異なります。",
  },
  {
  ...
  },
  {
    ...
    a: "提出会社単体の平均年齢は40.5歳（2026年3月期・有報）で、ミドル層が中核を占める組織です。電子部品・組込・データ解析などの専門性を持つ30代・40代の即戦力にとっては、経験が直接活きるポジションが想定されます。年齢よりも、事業領域に合致する専門スキルと実績が評価の鍵になります。",
  },
  {
    q: "村田製作所の働き方や評判は？",
...
export default function MurataCompanyPage() {
  ...
  return (
    <>
      <ArticleJsonLd title="村田製作所 エンジニア転職ガイド" description="村田製作所へのエンジニア転職を実データで解説。有価証券報告書の平均年収838万円（2026年3月期・全従業員平均）、電子部品（MLCC）・通信モジュール・組込・データ解析の技術領域、選考、30代40代の現実までまとめました。" url="/company/murata/" />
      ...
      <article className="max-w-4xl mx-auto px-4 py-10">
        ...
        <div className="bg-petrol-soft border-l-4 border-petrol-deep rounded-r-xl p-6 mb-6">
          ...
          <p className="text-sm leading-7 text-slate-700 mb-3"><strong>結論: 提出会社（株式会社村田製作所単体）の平均年間給与は838万円です（2026年3月期 有価証券報告書・全従業員平均、平均年齢40.5歳）。</strong></p>
          <ul className="text-sm leading-7 text-slate-700 space-y-1.5"><li>・平均年間給与 838万円（2026年3月期 有報・提出会社単体／全従業員平均）。技術職に限定した値ではありません。</li><li>・推移は2024年3月期760万円→2025年3月期803万円→2026年3月期838万円と上昇（各期 有報）。</li><li>・職種・等級別の公式な年収レンジは非公表。提示額は職種・等級・実績で個別決定されるため、求人票・面談での確認が必要です。</li></ul>
        </div>
        ...
        <section id="conclusion" className="mb-10">
          <div className="bg-petrol-soft border border-[var(--line)] rounded-xl p-6">
            ...
            <p className="text-sm text-blue-900 leading-relaxed mb-3">
              村田製作所は<strong>電子部品（MLCC）で世界トップシェアを持つメーカー大手</strong>で、電子部品設計・通信モジュール・組込・データ解析/AI・製造IoTと技術領域が広いのが特徴です。年収は提出会社単体の全従業員平均で838万円（2026年3月期・有報）。製造業出身で電子部品・組込・データ解析の専門性を持つミドルエンジニアの業務知識が活きやすい環境です。
            </p>
            <ul className="text-sm text-blue-900 space-y-1.5">
              ...
              <li>● <strong>30代・40代</strong>：平均年齢40.5歳と年齢層に幅があり、専門性・実績があれば年齢はハンデになりにくい</li>
            </ul>
          </div>
        </section>
        ...
        <section id="basic" className="mb-10">
          ...
          <p className="text-xs text-slate-400 mt-2">※平均年間給与・平均年齢・従業員数は2026年3月期 有価証券報告書（提出会社＝株式会社村田製作所単体）に基づく全従業員平均値。技術職に限定した値ではありません。</p>
        </section>
        ...
        <section id="salary" className="mb-10">
          ...
          <p className="text-sm text-slate-600 leading-relaxed mb-4">
            上場企業である村田製作所は、有価証券報告書で提出会社単体の平均年間給与を開示しています。<strong>2026年3月期は838万円（平均年齢40.5歳・全従業員平均）</strong>です。
          </p>
        ...
        <section id="middle" className="mb-10">
          ...
          <div className="space-y-4 text-sm text-slate-600 leading-relaxed">
            <p>
              村田製作所は提出会社単体の平均年齢40.5歳（2026年3月期・有報）と、ミドル層が中核を占める組織です。年齢構成的に30代・40代で中途入社しても浮きにくく、<strong>電子部品・組込・データ解析などの専門性を持つミドルエンジニアにとって、これまでの業務知識が直接活きやすい</strong>のが特徴です。電子部品は需要が拡大している領域で、製造業出身者の中途評価が高い傾向にあります。
            </p>
            <p>
