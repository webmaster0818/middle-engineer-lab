      ...
      <article className="max-w-4xl mx-auto px-4 py-10">
        ...
        <section id="related">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {[{ name: "IT企業平均年収ランキング43社【有報準拠】", href: "/salary/company-ranking/" }, { name: "日立製作所の転職ガイド", href: "/company/hitachi/" }, { name: "パナソニックの転職ガイド", href: "/company/panasonic/" }, { name: "ソニーグループの転職ガイド", href: "/company/sony/" }, { name: "ヘルスケア業界の転職", href: "/industry/healthcare/" }, { name: "製造業エンジニアの転職", href: "/industry/manufacturing/" }, { name: "40代エンジニアの転職の現実", href: "/knowledge/40s-reality/" }].map((item, i) => (<Link key={i} href={item.href} className="block border border-slate-200 rounded-lg px-4 py-3 text-sm font-medium text-slate-700 hover:bg-slate-50 hover:border-blue-300 transition-colors">{item.name} →</Link>))}
          </div>
        </section>
      </article>
    </>
