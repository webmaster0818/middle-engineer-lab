    ...
    <>
      ...
      <article className="max-w-4xl mx-auto px-4 py-10">
        ...
        <section id="features" className="mb-10">
          ...
          <div className="space-y-4">
            <div className="bg-blue-50 rounded-lg p-5">
              ...
              <p className="text-sm text-blue-700">MonotaROは外部ベンダー依存ではなく、ECサイトと基幹システムを自社で内製開発する方針を掲げています。膨大な商品点数・受注を扱う大規模トラフィック環境での開発経験が積める点が特徴です。</p>
            </div>
            <div className="bg-blue-50 rounded-lg p-5">
              <h3 className="font-bold text-blue-800 mb-2">データドリブンな意思決定</h3>
              <p className="text-sm text-blue-700">検索・レコメンド・需要予測など、データ活用がビジネスの中核に位置づけられています。BigQuery等を用いた分析基盤が整備されており、データエンジニア・MLエンジニアの活躍領域が広いのが強みです。</p>
            </div>
            <div className="bg-blue-50 rounded-lg p-5">
              <h3 className="font-bold text-blue-800 mb-2">安定した事業基盤の上での開発</h3>
              <p className="text-sm text-blue-700">BtoBの間接資材ECという継続課金型に近い安定事業を背景に、長期目線でのシステム改善・基盤投資が行いやすい環境です。腰を据えて技術的負債と向き合いたいエンジニアに向いています。</p>
            </div>
          </div>
        </section>
        ...
        <section id="stack" className="mb-10">
          ...
          <div className="border border-slate-200 rounded-lg p-5">
            <ul className="space-y-2 text-sm text-slate-600">
              <li className="flex items-start gap-2"><span className="text-blue-600 shrink-0">●</span><span><strong>バックエンド</strong>：Python、Django、Go</span></li>
              <li className="flex items-start gap-2"><span className="text-blue-600 shrink-0">●</span><span><strong>フロントエンド</strong>：JavaScript、TypeScript、React</span></li>
              ...
              <li className="flex items-start gap-2"><span className="text-blue-600 shrink-0">●</span><span><strong>データ基盤</strong>：BigQuery、各種DWH、機械学習基盤</span></li>
              <li className="flex items-start gap-2"><span className="text-blue-600 shrink-0">●</span><span><strong>機械学習・AI</strong>：Python（検索・レコメンド・需要予測）</span></li>
            </ul>
          </div>
        ...
        <section id="flow" className="mb-10">
          ...
          <p className="text-sm text-slate-600 leading-relaxed mb-4">
            MonotaRO公式採用ページで案内されている一般的な流れです。最新の内容は<a href="https://www.monotaro.com/saiyo/" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">公式採用ページ</a>でご確認ください。
          </p>
        ...
        <section id="interview" className="mb-10">
          ...
          <ul className="space-y-2 text-sm text-slate-600 border border-slate-200 rounded-lg p-5">
            <li className="flex items-start gap-2"><span className="text-blue-600 shrink-0">●</span>Python等での実装力と、大規模システムを意識した設計の妥当性</li>
            <li className="flex items-start gap-2"><span className="text-blue-600 shrink-0">●</span>データ活用・分析をビジネス成果につなげた経験</li>
            <li className="flex items-start gap-2"><span className="text-blue-600 shrink-0">●</span>事業・顧客理解と、指標を意識した開発姿勢</li>
            <li className="flex items-start gap-2"><span className="text-blue-600 shrink-0">●</span>チームでの協働姿勢・継続的な改善志向</li>
          </ul>
        ...
        <section id="middle" className="mb-10">
          ...
          <div className="space-y-4 text-sm text-slate-600 leading-relaxed">
            ...
            <p>
              30代40代では、クラウド（<Link href="/skill/aws/" className="text-blue-600 hover:underline">AWS</Link>）やインフラ（<Link href="/skill/infrastructure/" className="text-blue-600 hover:underline">インフラ</Link>）の実務に、<Link href="/cert/aws-saa/" className="text-blue-600 hover:underline">AWS認定（SAA）</Link>などの資格を掛け合わせると評価につながりやすい領域です。<Link href="/age/40s/" className="text-blue-600 hover:underline">40代の転職事情</Link>や<Link href="/knowledge/salary-40s/" className="text-blue-600 hover:underline">40代の年収戦略</Link>も合わせて参考にしてください。
            </p>
          </div>
        </section>
