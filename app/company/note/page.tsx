      ...
      <article className="max-w-4xl mx-auto px-4 py-10">
        ...
        <section id="features" className="mb-10">
          ...
          <div className="space-y-4">
            <div className="bg-petrol-soft rounded-lg p-5">
              ...
              <p className="text-sm text-petrol-deep">noteは2014年のサービス開始以来、Ruby on Railsを中核に開発を続けています（公式エンジニアブログ）。月間アクティブユーザー規模の大きいメディアを支えるため、パフォーマンスやスケーラビリティの課題に向き合えるエンジニアが活きる環境です。</p>
            </div>
            <div className="bg-petrol-soft rounded-lg p-5">
              <h3 className="font-bold text-blue-800 mb-2">クリエイターエコノミーというドメイン</h3>
              <p className="text-sm text-petrol-deep">クリエイターが創作を続けられる「街」をつくることをコンセプトに掲げており、コンテンツ・出版・IP領域のドメイン知識が活きます。技術だけでなく、誰のためにどんな価値を作るかへの当事者意識が問われやすい文化です。</p>
            </div>
            <div className="bg-petrol-soft rounded-lg p-5">
              <h3 className="font-bold text-blue-800 mb-2">モダンな技術への段階的移行</h3>
              <p className="text-sm text-petrol-deep">フロントエンドはNuxt.jsからNext.jsへ、インフラはEC2からEKSへ段階的に移行を進めてきました（公式エンジニアブログ）。レガシーの刷新とモダン化の両方に関わる経験を積みたいエンジニアに向いた環境です。</p>
            </div>
          </div>
        </section>
        ...
        <section id="stack" className="mb-10">
          ...
          <div className="border border-slate-200 rounded-lg p-5">
            <ul className="space-y-2 text-sm text-slate-600">
              <li className="flex items-start gap-2"><span className="text-petrol shrink-0">●</span><span><strong>バックエンド</strong>：Ruby / Ruby on Rails（中心）、一部サブシステムで Go</span></li>
              <li className="flex items-start gap-2"><span className="text-petrol shrink-0">●</span><span><strong>フロントエンド</strong>：Nuxt.js から Next.js へ段階的移行（TypeScript）</span></li>
              <li className="flex items-start gap-2"><span className="text-petrol shrink-0">●</span><span><strong>データストア</strong>：MySQL（AWS Aurora）、Redis、Elasticsearch、DynamoDB など</span></li>
              <li className="flex items-start gap-2"><span className="text-petrol shrink-0">●</span><span><strong>インフラ</strong>：AWS（EKS）、Terraform による構成管理</span></li>
            </ul>
          </div>
        ...
        <section id="interview" className="mb-10">
          ...
          <ul className="space-y-2 text-sm text-slate-600 border border-slate-200 rounded-lg p-5">
            ...
            <li className="flex items-start gap-2"><span className="text-petrol shrink-0">●</span>大規模メディア・プラットフォームの運用・改善経験</li>
            <li className="flex items-start gap-2"><span className="text-petrol shrink-0">●</span>クリエイターエコノミー・コンテンツ文化への共感</li>
            <li className="flex items-start gap-2"><span className="text-petrol shrink-0">●</span>課題を自分の言葉で定義し、技術選定の背景を説明できるか</li>
          </ul>
        ...
        <section id="middle" className="mb-10">
          ...
          <div className="space-y-4 text-sm text-slate-600 leading-relaxed">
            ...
            <p>
              大規模Railsアプリの運用やモダン化の経験は、ミドル層の強みとして評価されやすい領域です。<Link href="/age/40s/" className="text-petrol hover:underline">40代の転職事情</Link>や<Link href="/knowledge/salary-40s/" className="text-petrol hover:underline">40代の年収戦略</Link>も合わせて参考にしてください。
            </p>
          </div>
        </section>
