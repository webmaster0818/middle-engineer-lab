      ...
      <article className="max-w-4xl mx-auto px-4 py-10">
        ...
        <section id="feature" className="mb-10">
          ...
          <div className="space-y-4">
            <div className="bg-blue-50 rounded-lg p-5"><h3 className="font-bold text-blue-800 mb-2">お店のDXを支えるマルチプロダクト</h3><p className="text-sm text-blue-700">ネットショップ作成、POSレジ、キャッシュレス決済、予約管理など、実店舗のDXに関わる複数プロダクトを一社で展開しています。プロダクトごとに技術スタックやドメインが異なるため、自分の経験に合う領域を選びやすく、横断的なキャリアも描ける環境です。</p></div>
            <div className="bg-blue-50 rounded-lg p-5"><h3 className="font-bold text-blue-800 mb-2">Rubyを中心とした技術文化</h3><p className="text-sm text-blue-700">Ruby/Railsを軸に、Go・Javaなどを適材適所で採用しています。Rubyコミッターが在籍するなどRubyへの貢献が知られており、Web系の技術カルチャーを重視するエンジニアに親和性があります。フロントエンドはReact・Vue・Next.js・Nuxtなど幅広く使われています。</p></div>
            <div className="bg-blue-50 rounded-lg p-5"><h3 className="font-bold text-blue-800 mb-2">実店舗オペレーションに直結するドメイン</h3><p className="text-sm text-blue-700">決済・POS・予約といった、実際のお店の現場オペレーションに直結する領域を扱います。お金や在庫、来店予約など、間違いが許されないドメインに向き合う堅実さが求められる一方、ユーザーの事業を支える実感を得やすいのが魅力です。</p></div>
          </div>
        </section>
        ...
        <section id="stack" className="mb-10">
          ...
          <div className="border border-slate-200 rounded-lg p-5">
            <ul className="space-y-2 text-sm text-slate-600">
              <li className="flex items-start gap-2"><span className="text-blue-600 shrink-0">●</span><span><strong>Ruby / Rails</strong>：主要プロダクトのサーバーサイド。Rubyコミッターが在籍</span></li>
              <li className="flex items-start gap-2"><span className="text-blue-600 shrink-0">●</span><span><strong>Java / Spring Boot・Go</strong>：プロダクトに応じたバックエンド</span></li>
              <li className="flex items-start gap-2"><span className="text-blue-600 shrink-0">●</span><span><strong>React / Vue / Next.js / Nuxt</strong>：フロントエンド</span></li>
              <li className="flex items-start gap-2"><span className="text-blue-600 shrink-0">●</span><span><strong>AWS・GCP・Terraform</strong>：クラウド基盤とInfrastructure as Code</span></li>
            </ul>
          </div>
          <p className="text-xs text-slate-500 mt-2">出典：STORES 公式採用サイト・技術発信の公開情報。各言語の市場感は<Link href="/skill/ruby/" className="text-blue-600 hover:underline">Ruby/Railsエンジニアの転職市場</Link>・<Link href="/skill/go/" className="text-blue-600 hover:underline">Goエンジニアの転職市場</Link>もあわせてご覧ください。</p>
        </section>
        ...
        <section id="salary" className="mb-10">
          ...
          <p className="text-xs text-slate-500">出典：転職クチコミ・集計サイト（いずれも公式値ではない参考値）。実際の提示は応募職種・経験に応じて個別に確認してください。年代別の相場感は<Link href="/knowledge/salary-30s/" className="text-blue-600 hover:underline">30代の年収相場</Link>・<Link href="/knowledge/salary-40s/" className="text-blue-600 hover:underline">40代の年収相場</Link>を参照してください。</p>
        </section>
        ...
        <section id="interview" className="mb-10">
          ...
          <ul className="space-y-2 text-sm text-slate-600">
            <li className="flex items-start gap-2"><span className="text-blue-600 shrink-0">✓</span>Ruby/RailsまたはGoによるWebサービスの開発運用経験と設計力</li>
            <li className="flex items-start gap-2"><span className="text-blue-600 shrink-0">✓</span>決済・POS・予約など店舗系ドメインへの理解と堅実さ</li>
            <li className="flex items-start gap-2"><span className="text-blue-600 shrink-0">✓</span>マルチプロダクト環境での自律的な課題発見・解決</li>
            <li className="flex items-start gap-2"><span className="text-blue-600 shrink-0">✓</span>ユーザー（お店）の事業に寄り添うプロダクト志向</li>
          </ul>
        </section>
