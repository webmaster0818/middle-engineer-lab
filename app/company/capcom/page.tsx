...
export const metadata: Metadata = {
  ...
  title: "カプコンの年収は平均985万円【2026年・有報】エンジニア転職・選考ガイド",
  description:
    "カプコンへのエンジニア転職を実データで解説。有価証券報告書の平均年収985万円（2026年3月期・単体全社員平均）、内製エンジンRE ENGINE中心のC++技術スタック、選考フロー、30代40代の現実までまとめました。",
};
...
const basicData: [string, string][] = [
  ...
  ["平均年間給与", "985万円（2026年3月期 有価証券報告書・単体全社員平均）"],
  ["平均年齢", "38.1歳（2026年3月期 有価証券報告書）"],
  ["従業員数", "3,593名（2026年3月期 提出会社=単体）"],
  ["本社所在地", "大阪府大阪市中央区"],
...
const faqs = [
  {
    q: "カプコンの平均年収はいくらですか？",
    a: "2026年3月期の有価証券報告書によると、提出会社（単体）の平均年間給与は985万円、平均年齢は38.1歳です。これは技術職に限らない全社員平均で、2021年3月期の603万円から年々上昇しています。背景には業績連動型の報酬制度や年収水準・初任給の引き上げがあります。",
  },
  {
    q: "カプコンの技術スタックは？",
  ...
  {
    q: "カプコンの年収が上がっている理由は？",
    a: "業績好調を背景に、業績連動型の報酬制度のもとで年収水準や初任給の引き上げが続いてきたためです。2022年3月期以降、複数回の昇給・初任給増額が実施され、平均年収は2021年3月期603万円から2026年3月期985万円へと5年間で380万円上昇しています（有価証券報告書ベース）。",
  },
  {
    q: "30代・40代でもカプコンに転職できますか？",
    a: "平均年齢38.1歳で、特定領域（エンジン、レンダリング、サーバー等）の専門性や開発実績があれば年齢自体は大きなハンデになりにくい傾向です。ゲーム業界の中途は専門性重視であり、自分の強みが活きるポジションを見極めることが重要です。",
  },
];
...
export default function CapcomCompanyPage() {
  ...
  return (
    <>
      <ArticleJsonLd title="カプコン エンジニア転職ガイド" description="カプコンへのエンジニア転職を実データで解説。有価証券報告書の平均年収985万円（2026年3月期・単体全社員平均）、内製エンジンRE ENGINE中心のC++技術スタック、選考フロー、30代40代の現実までまとめました。" url="/company/capcom/" />
      ...
      <article className="max-w-4xl mx-auto px-4 py-10">
        ...
        <div className="bg-petrol-soft border-l-4 border-petrol-deep rounded-r-xl p-6 mb-6">
          ...
          <p className="text-sm leading-7 text-slate-700 mb-3"><strong>結論: 株式会社カプコンの平均年間給与は985万円です（2026年3月期 有価証券報告書・提出会社単体／全社員平均、平均年齢38.1歳）。</strong></p>
          <ul className="text-sm leading-7 text-slate-700 space-y-1.5"><li>・平均年間給与 985万円（2026年3月期 有報・単体全社員平均）。技術職に限らない全社平均です。</li><li>・業績連動型報酬を背景に2021年3月期603万円から2026年3月期985万円へと5年で380万円上昇（各期 有報）。</li><li>・持株会社を介さず上場会社自身が開発するため有報の数字が現場像に比較的近い一方、提示は等級・ポジションで幅があり個別求人でご確認ください。</li></ul>
        </div>
        ...
        <section id="conclusion" className="mb-10">
          <div className="bg-petrol-soft border border-[var(--line)] rounded-xl p-6">
            ...
            <p className="text-sm text-blue-900 leading-relaxed mb-3">
              カプコンは<strong>内製エンジン「RE ENGINE」を軸にC++で大規模ゲームを開発する、技術志向の強いゲーム企業</strong>です。レンダリング・物理・AI・サーバー等、専門領域ごとに採用しており、専門性で勝負したいエンジニアに向きます。業績好調を背景に平均年収は5年で380万円上昇しています（単体全社員平均985万円・2026年3月期）。
            </p>
        ...
        <section id="basic" className="mb-10">
          ...
          <p className="text-xs text-slate-400 mt-2">※平均年間給与・平均年齢・従業員数は2026年3月期 有価証券報告書に基づく提出会社（単体）の全社員平均値。技術スタックは公式採用ページ（2026年6月時点）。</p>
        </section>
        ...
        <section id="features" className="mb-10">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-petrol-soft rounded-lg p-5">
              ...
              <p className="text-sm text-petrol-deep">業績連動型の報酬制度のもと、平均年収は2021年3月期の603万円から2026年3月期の985万円へと5年で380万円上昇しています（有価証券報告書ベース）。会社の成長が報酬に反映されやすい設計です。</p>
            </div>
          </div>
        </section>
        ...
        <section id="salary" className="mb-10">
          ...
          <p className="text-sm text-slate-600 leading-relaxed mb-4">
            上場会社であるカプコンは、有価証券報告書で提出会社（単体）の平均年間給与を開示しています。<strong>2026年3月期は985万円（平均年齢38.1歳・単体全社員平均）</strong>で、業績連動の報酬制度を背景に一貫した上昇傾向にあります。
          </p>
        ...
        <section id="middle" className="mb-10">
          ...
          <div className="space-y-4 text-sm text-slate-600 leading-relaxed">
            <p>
              カプコンの中途採用は<strong>専門性重視</strong>です。RE ENGINE関連、レンダリング、物理、AI、サーバーサイドなど、特定領域での実務経験・実績が問われます。30代・40代でも、その領域で価値を出せる実力があれば年齢自体は大きなハンデになりにくいのが実情です。平均年齢38.1歳と、ミドル層も十分に活躍できる年齢構成です。
            </p>
            <p>
