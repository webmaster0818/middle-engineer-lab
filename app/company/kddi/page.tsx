    ...
    <>
      ...
      <article className="max-w-4xl mx-auto px-4 py-10">
        ...
        <section id="features" className="mb-10">
          ...
          <div className="space-y-4">
            <div className="bg-petrol-soft rounded-lg p-5">
              ...
              <p className="text-sm text-petrol-deep">国内屈指の通信ネットワークを基盤に、5G・クラウド・AI領域へ事業を拡張しています。AWS・Azure・GCPといったメガクラウドに加え、自社クラウドサービスKCPSも展開し、提案・設計・構築までを担うクラウドエンジニアを募集しています。</p>
            </div>
            <div className="bg-petrol-soft rounded-lg p-5">
              <h3 className="font-bold text-blue-800 mb-2">ジョブ型人事制度で専門性を評価</h3>
              <p className="text-sm text-petrol-deep">「KDDI版ジョブ型人事制度」を導入し、職務に応じて役割・処遇が決まります。エンジニアは専門性を高めること自体が評価される設計とされ、スペシャリスト志向の中途採用と相性が良いのが特徴です。</p>
            </div>
            <div className="bg-petrol-soft rounded-lg p-5">
              <h3 className="font-bold text-blue-800 mb-2">データ・AI領域の強化</h3>
              <p className="text-sm text-petrol-deep">AI活用に不可欠な大規模計算基盤の整備を進めており、データ基盤・AI領域の求人ではSnowflake・Tableau等のBI、Hadoop・Spark・Kafka等の並列分散処理の経験が求められる募集も見られます。</p>
            </div>
          </div>
        </section>
        ...
        <section id="stack" className="mb-10">
          ...
          <div className="border border-slate-200 rounded-lg p-5">
            <ul className="space-y-2 text-sm text-slate-600">
              <li className="flex items-start gap-2"><span className="text-petrol shrink-0">●</span><span><strong>クラウド</strong>：AWS／Azure／GCP、自社クラウドKCPSの提案・設計・構築・運用</span></li>
              <li className="flex items-start gap-2"><span className="text-petrol shrink-0">●</span><span><strong>データ基盤・AI</strong>：Snowflake・Tableau等のBI、Hadoop・Spark・Kafka等の並列分散処理、機械学習</span></li>
              <li className="flex items-start gap-2"><span className="text-petrol shrink-0">●</span><span><strong>通信ネットワーク</strong>：5G・コアネットワーク、ネットワーク基盤の設計・運用</span></li>
              <li className="flex items-start gap-2"><span className="text-petrol shrink-0">●</span><span><strong>法人DX・アプリケーション</strong>：法人向けDXソリューション、業務システム開発</span></li>
              <li className="flex items-start gap-2"><span className="text-petrol shrink-0">●</span><span><strong>セキュリティ</strong>：通信・クラウド基盤のセキュリティ</span></li>
            </ul>
          </div>
        ...
        <section id="flow" className="mb-10">
          ...
          <p className="text-sm text-slate-600 leading-relaxed mb-4">
            KDDIのキャリア採用ページで公開されている一般的な流れです。最新の内容は<a href="https://career.kddi.com/career/recruit/" className="text-petrol hover:underline" target="_blank" rel="noopener noreferrer">公式キャリア採用ページ</a>でご確認ください。
          </p>
        ...
        <section id="interview" className="mb-10">
          ...
          <ul className="space-y-2 text-sm text-slate-600 border border-slate-200 rounded-lg p-5">
            <li className="flex items-start gap-2"><span className="text-petrol shrink-0">●</span>クラウド・データ・AI・通信など募集職務（ジョブ）における実務経験と専門性</li>
            <li className="flex items-start gap-2"><span className="text-petrol shrink-0">●</span>大規模インフラ・大量データを扱うシステムの設計・運用経験</li>
            <li className="flex items-start gap-2"><span className="text-petrol shrink-0">●</span>通信とITの融合領域・事業変革に貢献する姿勢</li>
            <li className="flex items-start gap-2"><span className="text-petrol shrink-0">●</span>多部門・パートナーと協働してプロジェクトを進める推進力</li>
          </ul>
