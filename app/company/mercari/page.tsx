...
export default function MercariCompanyPage() {
  ...
  return (
    <>
      ...
      <Breadcrumb items={[{ name: "IT企業平均年収ランキング43社【有報準拠】", href: "/salary/company-ranking/" }, { name: "ホーム", href: "/" }, { name: "企業別ガイド", href: "/company/" }, { name: "メルカリ" }]} />
      ...
      <article className="max-w-4xl mx-auto px-4 py-10">
        ...
        <section id="features" className="mb-10">
          ...
          <div className="space-y-4">
            <div className="bg-blue-50 rounded-lg p-5">
              ...
              <p className="text-sm text-blue-700">公式採用情報によると、所属エンジニアの約半数が外国籍で、実際に英語で業務が行われています。海外からの転職者も在籍し、グローバルスタンダードの開発プロセスが整備されています。</p>
            </div>
            <div className="bg-blue-50 rounded-lg p-5">
              <h3 className="font-bold text-blue-800 mb-2">Go・GCPベースのマイクロサービス</h3>
              <p className="text-sm text-blue-700">バックエンドはGo・Pythonを中心に、Docker・Kubernetes・GCP/AWSでマイクロサービスを運用しています（公式技術スタックページ）。サービスごとに最適な技術を選ぶ方針が示されています。</p>
            </div>
            <div className="bg-blue-50 rounded-lg p-5">
              <h3 className="font-bold text-blue-800 mb-2">ミッション・バリュー重視の選考</h3>
              <p className="text-sm text-blue-700">公式ブログによると、面接は「ミッションへの共感」「バリューの体現」「カルチャーフィット」を判断するために行われます。技術力だけでなくカルチャー適合が明確に評価軸に含まれています。</p>
            </div>
          </div>
        </section>
        ...
        <section id="stack" className="mb-10">
          ...
          <div className="border border-slate-200 rounded-lg p-5">
            <ul className="space-y-2 text-sm text-slate-600">
              <li className="flex items-start gap-2"><span className="text-blue-600 shrink-0">●</span><span><strong>バックエンド</strong>：Go、Python</span></li>
              <li className="flex items-start gap-2"><span className="text-blue-600 shrink-0">●</span><span><strong>Webフロントエンド</strong>：TypeScript、React、Next.js、Vue.js</span></li>
              <li className="flex items-start gap-2"><span className="text-blue-600 shrink-0">●</span><span><strong>モバイル</strong>：iOS は Swift / SwiftUI、Android は Kotlin / Jetpack Compose</span></li>
              <li className="flex items-start gap-2"><span className="text-blue-600 shrink-0">●</span><span><strong>インフラ</strong>：Docker、Kubernetes、Google Cloud Platform、Amazon Web Services</span></li>
              <li className="flex items-start gap-2"><span className="text-blue-600 shrink-0">●</span><span><strong>データ基盤</strong>：Cloud Spanner、MySQL、PostgreSQL、Redis、TiDB、BigQuery、Elasticsearch など</span></li>
              <li className="flex items-start gap-2"><span className="text-blue-600 shrink-0">●</span><span><strong>機械学習・AIツール</strong>：Python（PyTorch / scikit-learn）、GitHub Copilot 等</span></li>
            </ul>
          </div>
        ...
        <section id="flow" className="mb-10">
          ...
          <p className="text-sm text-slate-600 leading-relaxed mb-4">
            メルカリのエンジニアリングブログで公開されている選考プロセスをもとにした一般的な流れです。最新の内容は<a href="https://careers.mercari.com/jobs/engineering/" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">公式採用ページ</a>でご確認ください。
          </p>
        ...
        <section id="interview" className="mb-10">
          ...
          <ul className="space-y-2 text-sm text-slate-600 border border-slate-200 rounded-lg p-5">
            <li className="flex items-start gap-2"><span className="text-blue-600 shrink-0">●</span>コーディングテスト・技術課題で示す実装力と設計の妥当性</li>
            <li className="flex items-start gap-2"><span className="text-blue-600 shrink-0">●</span>ミッションへの共感とバリュー（Go Bold等）の体現</li>
            <li className="flex items-start gap-2"><span className="text-blue-600 shrink-0">●</span>カルチャーフィット・チームでの協働姿勢</li>
            <li className="flex items-start gap-2"><span className="text-blue-600 shrink-0">●</span>英語を含むコミュニケーション（ポジションにより程度は異なる）</li>
          </ul>
        ...
        <section id="middle" className="mb-10">
          ...
          <div className="space-y-4 text-sm text-slate-600 leading-relaxed">
            ...
            <p>
              英語環境は、これまで英語での業務経験がない場合でもポジションによっては挑戦可能ですが、各求人の語学要件を必ず確認しましょう。<Link href="/age/40s/" className="text-blue-600 hover:underline">40代の転職事情</Link>や<Link href="/knowledge/salary-40s/" className="text-blue-600 hover:underline">40代の年収戦略</Link>も合わせて参考にしてください。
            </p>
          </div>
        </section>
