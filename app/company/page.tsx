...
const categories = [
  ...
  },
  {
    ...
    companies: [
      ...
      { slug: "murata", name: "村田製作所", salary: "全社平均838万円(2026/3)", tech: "電子部品(MLCC) / 通信モジュール / 組込", desc: "MLCC世界トップの電子部品大手。" },
      { slug: "renesas", name: "ルネサスエレクトロニクス", salary: "全社平均809万円(2024/12)", tech: "半導体設計 / HDL / EDA / 組込", desc: "マイコン・SoCの半導体大手。需要逼迫で経験者評価が高い。" },
      { slug: "tokyo-electron", name: "東京エレクトロン", salary: "全社平均1,380万円(2026/3)", tech: "装置制御 / 組込 / 画像処理 / AI", desc: "半導体製造装置の世界大手。製造業最高水準の年収。" },
      ...
      { slug: "ricoh", name: "リコー", salary: "単体906万円(2026/3)", tech: "組込み / クラウド / データ・AI", desc: "複合機からデジタルサービスへ転換する精密大手。" },
  ...
  },
  {
    ...
    companies: [
      ...
      { slug: "capcom", name: "カプコン", salary: "985万円(2026/3単体)", tech: "C++ / 内製RE ENGINE", desc: "モンハン・スト6。内製エンジン中心の開発。" },
      { slug: "konami", name: "コナミ", salary: "持株850万円(開発はコナミデジタル)", tech: "C / C++ / C#", desc: "eFootball・遊戯王・桃鉄の総合エンタメ。" },
      ...
      { slug: "mixi", name: "MIXI（ミクシィ）", salary: "単体847万円(2026/3)", tech: "Go / Ruby / Swift / Kotlin / C++", desc: "モンスト・みてね等を展開するエンタメ企業。" },
  ...
  },
  {
    ...
    companies: [
      { slug: "sakura-internet", name: "さくらインターネット", salary: "全社平均741万円(2026/3)", tech: "Linux / KVM / OpenStack / K8s / Terraform", desc: "DC・自社クラウド・GPU基盤を運営する国産インフラ。" },
  ...
  },
  {
    ...
    companies: [
      { slug: "kddi", name: "KDDI", salary: "単体1,051万円(2026/3)", tech: "5G / クラウド / データ・AI", desc: "通信×ITを軸に事業拡張する通信大手。" },
      { slug: "ntt", name: "NTT（日本電信電話）", salary: "持株単体1,056万円(2026/3)", tech: "IOWN / AI / クラウド / ソフトウェア工学", desc: "グループのR&Dを担う持株会社。事業会社とは別。" },
