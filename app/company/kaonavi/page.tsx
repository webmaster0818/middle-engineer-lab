...
export default function KaonaviCompanyPage() {
  ...
  return (
    <>
      ...
      <Breadcrumb items={[{ name: "AWSの転職ガイド", href: "/skill/aws/" }, { name: "フロントエンドスペシャリスト路線の転職ガイド", href: "/skill/react/" }, { name: "フルスタックの転職ガイド", href: "/skill/typescript/" }, { name: "PHPの転職ガイド", href: "/skill/php/" }, { name: "Laravelの転職ガイド", href: "/skill/laravel/" }, { name: "IT企業平均年収ランキング43社【有報準拠】", href: "/salary/company-ranking/" }, { name: "ホーム", href: "/" }, { name: "企業別ガイド", href: "/company/" }, { name: "カオナビ" }]} />
