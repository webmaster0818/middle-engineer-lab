...
export const metadata: Metadata = {
  ...
  description:
    "バンダイナムコオンラインの平均年齢は34歳・従業員212名(2022年3月時点の公表値)。同社は2025年4月1日付でバンダイナムコエンターテインメントに吸収合併され消滅しました。あわせてバンダイナムコのエンジニア中途採用を有価証券報告書・公式採用ページの一次情報で解説。持株会社平均年収1,216万円(2025年3月期)の注意点、内製エンジンSOL-AVES等の技術を中立にまとめました。",
};
    ...
    <>
      ...
      <article className="max-w-4xl mx-auto px-4 py-10">
        ...
        <div className="bg-petrol-soft border-l-4 border-petrol-deep rounded-r-xl p-6 mb-6">
          ...
          <ul className="text-sm leading-7 text-slate-700 space-y-1.5"><li>・持株会社（BNHD）単体の平均年収1,216万円・平均年齢46.7歳（2025年3月期 有報）。経営管理機能中心で従業員は数十名規模。</li><li>・開発会社（バンダイナムコスタジオ等）の職種別・等級別年収は非開示。当ガイドでは推測の数値表は掲載していません。</li><li>・口コミでは賞与比率が高く、IT系企業と比べ待遇面で見劣りするとの声も。実際の処遇は応募先の会社単位でご確認ください。</li><li>・<strong>バンダイナムコオンラインの平均年齢は34歳・従業員212名（2022年3月時点の公表値）。同社は2025年4月1日付でバンダイナムコエンターテインメントに吸収合併され、現在は存在しません</strong>（<a href="#online" className="text-petrol underline">詳細</a>）。</li></ul>
        </div>
