...
export const metadata: Metadata = {
  title: "バンダイナムコの年収は平均1216万円【2026年・有報】エンジニア転職・選考ガイド",
  description:
      ...
      <article className="max-w-4xl mx-auto px-4 py-10">
        ...
        <section id="feature" className="mb-10">
          ...
          <div className="space-y-4">
            <div className="bg-blue-50 rounded-lg p-5"><h3 className="font-bold text-blue-800 mb-2">世界的IPの大規模ゲーム開発</h3><p className="text-sm text-blue-700">ガンダム、ドラゴンボール、鉄拳、テイルズなどの人気IPを軸に、家庭用・モバイル・オンラインの各プラットフォームでゲームを開発します。大規模タイトルではチーム開発・長期開発のノウハウが求められます。</p></div>
            <div className="bg-blue-50 rounded-lg p-5"><h3 className="font-bold text-blue-800 mb-2">内製エンジン『SOL-AVES』と職種の細分化</h3><p className="text-sm text-blue-700">バンダイナムコスタジオでは内製ゲームエンジン『SOL-AVES』を中心に、グラフィックス／エディタ／ツール／自動テストの各エンジニア職が分かれています。ゲームAIエンジニアや機械学習のR&Dエンジニアなど、専門領域ごとの募集がある点が特徴です。</p></div>
            <div className="bg-blue-50 rounded-lg p-5"><h3 className="font-bold text-blue-800 mb-2">会社ごとに分かれる採用窓口</h3><p className="text-sm text-blue-700">開発はバンダイナムコスタジオ、企画・販売はバンダイナムコエンターテインメント、オンライン運用はバンダイナムコオンラインなど、機能ごとに会社が分かれています。応募先の選定が最初のステップになります。</p></div>
          </div>
        </section>
        ...
        <section id="stack" className="mb-10">
          ...
          <div className="border border-slate-200 rounded-lg p-5">
            <ul className="space-y-2 text-sm text-slate-600">
              <li className="flex items-start gap-2"><span className="text-blue-600 shrink-0">●</span><span><strong>C++</strong>：家庭用ゲーム開発（クライアント／グラフィックス）の中核言語</span></li>
              <li className="flex items-start gap-2"><span className="text-blue-600 shrink-0">●</span><span><strong>内製ゲームエンジン『SOL-AVES』</strong>：グラフィックス／エディタ／ツール／自動テストの各エンジニア職</span></li>
              <li className="flex items-start gap-2"><span className="text-blue-600 shrink-0">●</span><span><strong>サーバ／ネットワーク</strong>：サーバエンジニア・ネットワークプログラマの職種あり</span></li>
              <li className="flex items-start gap-2"><span className="text-blue-600 shrink-0">●</span><span><strong>機械学習</strong>：シニア／一般のR&Dエンジニア（機械学習）職、ゲームAIエンジニア職</span></li>
              <li className="flex items-start gap-2"><span className="text-blue-600 shrink-0">●</span><span>Unity・Unreal Engine：プロジェクト・職種により使用（募集要項で要確認）</span></li>
            </ul>
          </div>
        ...
        <section id="interview" className="mb-10">
          ...
          <ul className="space-y-2 text-sm text-slate-600">
            <li className="flex items-start gap-2"><span className="text-blue-600 shrink-0">✓</span>応募職種（グラフィックス／サーバ／ゲームAI／ML等）に対応した実装力と専門性</li>
            <li className="flex items-start gap-2"><span className="text-blue-600 shrink-0">✓</span>C++・ゲームエンジン周辺の理解と、大規模チーム開発での協働経験</li>
            <li className="flex items-start gap-2"><span className="text-blue-600 shrink-0">✓</span>IP・ゲームへの理解と、エンタテインメント体験を技術で支える姿勢</li>
            <li className="flex items-start gap-2"><span className="text-blue-600 shrink-0">✓</span>長期・大規模タイトルの品質を支えるための設計・テストへの意識</li>
          </ul>
        </section>
        ...
        <section id="middle" className="mb-10">
          ...
          <div className="space-y-4 text-sm text-slate-600 leading-relaxed">
            ...
            <p>転職判断では年収相場の把握が欠かせません。<Link href="/knowledge/salary-40s/" className="text-blue-600 hover:underline">40代の年収相場</Link>や<Link href="/knowledge/offer-compare/" className="text-blue-600 hover:underline">オファー比較の進め方</Link>もあわせて確認してください。</p>
          </div>
        </section>
