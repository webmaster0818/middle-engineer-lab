...
const faqs = [
  ...
  },
  {
    ...
    a: "事業会社の株式会社リクルート自体は非上場のため、同社単独の有価証券報告書はありません。持株会社の株式会社リクルートホールディングス（6098）の有価証券報告書（2025年3月期）では全社員平均年収1,145万円（平均年齢40.5歳）が公表されています。これは持株会社の全社員平均であり、エンジニア職に限定した値ではありません。",
  },
  {
