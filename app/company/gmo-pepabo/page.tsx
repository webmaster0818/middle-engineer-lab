...
export const metadata: Metadata = {
  alternates: { canonical: "/company/gmo-pepabo/" },
    ...
    <>
      ...
      <article className="max-w-4xl mx-auto px-4 py-10">
        ...
        <section id="features" className="mb-10">
          ...
          <div className="space-y-4">
            <div className="bg-petrol-soft rounded-lg p-5">
              ...
              <p className="text-sm text-petrol-deep">ロリポップ等のホスティング基盤、minne等のtoC向けマーケット、カラーミーショップ等のEC支援まで、性質の異なる複数事業があります。インフラ寄りからアプリ寄りまで、希望や強みに応じたキャリアが描けます。</p>
            </div>
            <div className="bg-petrol-soft rounded-lg p-5">
              <h3 className="font-bold text-blue-800 mb-2">Ruby文化と活発な技術発信</h3>
              <p className="text-sm text-petrol-deep">Ruby／Ruby on Railsの文化が根付き、ペパボテックブログやカンファレンス登壇、OSS活動など技術発信が活発です。社内の研究開発的な取り組みもあり、技術を深め発信したい人に向いた環境です。</p>
            </div>
            <div className="bg-petrol-soft rounded-lg p-5">
              <h3 className="font-bold text-blue-800 mb-2">地方拠点・多様な働き方</h3>
              <p className="text-sm text-petrol-deep">福岡・鹿児島などにも開発拠点があり、リモートを含む多様な働き方が示されています。勤務地・勤務形態はポジションにより異なるため、各求人の条件を確認することが推奨されます。</p>
            </div>
          </div>
        </section>
        ...
        <section id="stack" className="mb-10">
          ...
          <div className="border border-slate-200 rounded-lg p-5">
            <ul className="space-y-2 text-sm text-slate-600">
              <li className="flex items-start gap-2"><span className="text-petrol shrink-0">●</span><span><strong>バックエンド</strong>：Ruby、Ruby on Rails、Go、PHP</span></li>
              ...
              <li className="flex items-start gap-2"><span className="text-petrol shrink-0">●</span><span><strong>インフラ</strong>：Linux、Kubernetes、Docker、AWS、Google Cloud Platform</span></li>
              <li className="flex items-start gap-2"><span className="text-petrol shrink-0">●</span><span><strong>データ</strong>：MySQL、PostgreSQL、各種DWH</span></li>
              <li className="flex items-start gap-2"><span className="text-petrol shrink-0">●</span><span><strong>運用</strong>：IaC、CI/CD、監視・オブザーバビリティ基盤</span></li>
            </ul>
          </div>
        ...
        <section id="flow" className="mb-10">
          ...
          <p className="text-sm text-slate-600 leading-relaxed mb-4">
            GMOペパボ公式採用ページで案内されている一般的な流れです。最新の内容は<a href="https://recruit.pepabo.com/" className="text-petrol hover:underline" target="_blank" rel="noopener noreferrer">公式採用ページ</a>でご確認ください。
          </p>
        ...
        <section id="interview" className="mb-10">
          ...
          <ul className="space-y-2 text-sm text-slate-600 border border-slate-200 rounded-lg p-5">
            <li className="flex items-start gap-2"><span className="text-petrol shrink-0">●</span>Ruby on Rails等でのWebアプリ実装力／設計の妥当性</li>
            <li className="flex items-start gap-2"><span className="text-petrol shrink-0">●</span>ホスティング基盤などインフラ・SREの理解（該当ポジション）</li>
            <li className="flex items-start gap-2"><span className="text-petrol shrink-0">●</span>サービス・ユーザーへの関心と、技術発信・アウトプット姿勢</li>
            <li className="flex items-start gap-2"><span className="text-petrol shrink-0">●</span>チームでの協働姿勢・カルチャーフィット</li>
          </ul>
        ...
        <section id="middle" className="mb-10">
          ...
          <div className="space-y-4 text-sm text-slate-600 leading-relaxed">
            ...
            <p>
              インフラ寄りのキャリアを志向するなら、<Link href="/skill/infrastructure/" className="text-petrol hover:underline">インフラ</Link>や<Link href="/skill/aws/" className="text-petrol hover:underline">クラウド</Link>の実務に<Link href="/cert/aws-saa/" className="text-petrol hover:underline">AWS認定（SAA）</Link>などの資格を掛け合わせると専門性を示しやすくなります。<Link href="/age/40s/" className="text-petrol hover:underline">40代の転職事情</Link>や<Link href="/knowledge/salary-40s/" className="text-petrol hover:underline">40代の年収戦略</Link>も合わせて参考にしてください。
            </p>
          </div>
        </section>
        ...
        <section id="related">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {[
              ...
              { name: "クラスメソッドの転職ガイド", href: "/company/classmethod/" },
              { name: "フューチャー（Future）の転職ガイド", href: "/company/future/" },
